...
[![Open Lab](https://img.shields.io/badge/▶️_Open_Lab-4285F4?style=for-the-badge&logo=googlecloud&logoColor=white)](https://www.skills.google/games/6982/labs/43383)
...
graph LR
    ...
    style F fill:#34A853,stroke:#188038,color:#fff
...
```bash
bq mk work_day && bq load --source_format=CSV --skip_leading_rows=1 work_day.employee gs://YOUR_BUCKET_NAME/employees.csv employee_id:INTEGER,device_id:STRING,username:STRING,department:STRING,office:STRING
```

⚠️ **Important:**  
This command contains a **placeholder value**. Before running it, make sure to replace:

- `YOUR_BUCKET_NAME` → the exact Cloud Storage bucket name provided in your lab instructions

Using an incorrect bucket name will cause the `bq load` operation to fail.
