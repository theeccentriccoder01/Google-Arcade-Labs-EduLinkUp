...
```bash
curl -LO https://raw.githubusercontent.com/theeccentriccoder/Google-Arcade-Labs-EduLinkUp/main/Using%20Role-based%20Access%20Control%20in%20Kubernetes%20Engine/EduLinkUp.sh
