...
```
   git clone https://github.com/YOUR_USERNAME/Google-Arcade-Labs-EduLinkUp.git
```

**3.** Navigate to the project directory.
```
   cd Google-Arcade-Labs-EduLinkUp
```
...
```
   git remote add upstream https://github.com/theeccentriccoder01/Google-Arcade-Labs-EduLinkUp.git
```
