...
[![Open Lab](https://img.shields.io/badge/▶️_Open_Lab-4285F4?style=for-the-badge&logo=googlecloud&logoColor=white)](https://www.skills.google/games/6982/labs/43381)
...
⚠️ **Important:**  
This script contains **placeholder values**. Before running it, make sure to replace:

- `YOUR_PROJECT_ID` → your active Google Cloud project ID  
- `YOUR_LOCATION` → a supported Vertex AI region (for example: `us-central1`)
