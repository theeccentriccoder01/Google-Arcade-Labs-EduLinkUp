...
> **Important:** Set values for `BUCKET_NAME=` and `IP_ADDRESS` before running Commands.

> **If score is not coming:** Re-run the following commands multiple times until you get the score:
